...
namespace TsMath
{
	...
	public partial class PrimeNumbers
	{
		...
		/// <returns>a</returns>
		static long FactorPow2(long d, out long r)
		{
			r = 0;
			while ((d & 1) == 0)
			{
		...
		public static long GuessPrimeFactor(long num)
		{
		...
		/// </returns>
		public static bool IsProbablyPrime_MillerRabinTest(long n, long k, RandomXorShift rand)
		{
			var n1 = n - 1;
		...
		///   <b>true</b> if the number <paramref name="n"/> is probable a prime number; <b>false</b>, if the number is composite.
		/// </returns>
		public static bool SPRP(long n, long b)
		{
			var nMinus1 = n - 1;
		...
		static List<(long factor, int count)> GetPrimeFactors(long num, Func<long,long> nextPrimeFunc)
		{
		...
		static long NextPrime(long num, Func<long, bool> isPrimeFunc)
		{
			if (num <= 1)
				return 2;
			if (num <= 2)
